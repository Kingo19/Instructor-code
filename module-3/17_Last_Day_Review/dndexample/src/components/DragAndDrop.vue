<template>
  <div class="center-panel">
    ...
    <div>
      <confirmation-modal v-show="showModal" @close-modal="showModal = false" emp_name="Steve" />
    </div>
    <div class="save-btn">
      <button class="button" @click="showModal = true" >Save List</button>
    </div>
  </div>
</template>
